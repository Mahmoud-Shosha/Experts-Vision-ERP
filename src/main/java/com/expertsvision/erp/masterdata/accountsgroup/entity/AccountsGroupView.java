package com.expertsvision.erp.masterdata.accountsgroup.entity;
...
/**
 * The persistent class for the accounts_group_view database table.
 * 
 */
@Entity
@Table(name="accounts_group_view")
@NamedQuery(name="AccountsGroupView.findAll", query="SELECT a FROM AccountsGroupView a")
public class AccountsGroupView implements Serializable {
	...
	public String toString() {
		return "AccountsGroupView [addDate=" + addDate + ", addUser=" + addUser + ", addUserDName=" + addUserDName
