package com.expertsvision.erp.masterdata.accountsgroup.dto;

import com.fasterxml.jackson.annotation.JsonProperty;

public class AccountsGroupViewFilter {
	...
	public String toString() {
		return "AccountsGroupViewFilter [groupNo=" + groupNo + ", groupDName=" + groupDName + ", groupFName="
				+ groupFName + "]";
	}
