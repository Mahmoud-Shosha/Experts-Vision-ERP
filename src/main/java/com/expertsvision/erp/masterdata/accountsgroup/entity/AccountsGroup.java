...
/**
 * The persistent class for the accounts_group database table.
 * 
 */
@Entity
@Table(name="accounts_group")
@NamedQuery(name="AccountsGroup.findAll", query="SELECT a FROM AccountsGroup a")
public class AccountsGroup implements Serializable {
	...
	public String toString() {
		return "AccountsGroup [groupNo=" + groupNo + ", addDate=" + addDate + ", addUser=" + addUser + ", groupDName="
