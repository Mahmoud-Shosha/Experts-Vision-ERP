...
/**
 * The persistent class for the cost_center_group_view database table.
 * 
 */
@Entity
@Table(name="cost_center_group_view")
@NamedQuery(name="CostCenterGroupView.findAll", query="SELECT c FROM CostCenterGroupView c")
public class CostCenterGroupView implements Serializable {
	...
	public String toString() {
		return "CostCenterGroupView [addDate=" + addDate + ", addUser=" + addUser + ", addUserDName=" + addUserDName
