...
public interface MasterDataPrivilegesDAO {
	...
	List<CashInHandVirtualPK> getCashesVirtualPK();

	List<CashInHandVirtualPK> getCashesVirtualPKFromPrivsTable(Integer userId);

	List<Object[]> getCashesPrivs(Integer userId);

	List<Object[]> getCashesPrivs(Set<Integer> userIdList, Set<Integer> cashNoList);
