...
/**
 * The persistent class for the country_view database table.
 * 
 */
@Entity
@Table(name="country_view")
@NamedQuery(name="CountryView.findAll", query="SELECT c FROM CountryView c")
public class CountryView implements Serializable {
	...
	public String toString() {
		return "CountryView [addDate=" + addDate + ", addUser=" + addUser + ", addUserDName=" + addUserDName
				+ ", addUserFName=" + addUserFName + ", countryDName=" + countryDName + ", countryFName=" + countryFName
				+ ", countryNo=" + countryNo + ", modifyDate=" + modifyDate + ", modifyUser=" + modifyUser
				+ ", modifyUserDName=" + modifyUserDName + ", modifyUserFName=" + modifyUserFName + ", regionNo="
